        ...
        <cfif arguments.oldData.recordCount>
            ...
            <cftry>
                ...
                <cfif local.rData.statusCode neq "200 OK">
                    <cfmail to="errors" from="errors" subject="Call to Audit Log failed with code #local.rData.statusCode# #cgi.server_name#" type="text">
                        <cfoutput>
    ...
    <cffunction name="auditLogEntryAnswers" access="public" returnType="void" output="false" hint="Posts to API to log answer changes">
        ...
        <cfif structCount(arguments.oldData)>
            ...
            <cftry>
                ...
                <!--- We want to log any errors with reaching the audit log server or posting audit log information. --->
                <cfif local.rData.statusCode neq "200 OK">
                    <cfmail to="errors" from="errors" subject="Call to Audit Log failed with code #local.rData.statusCode# #cgi.server_name#" type="text" server="smtp.mandrillapp.com" username="ECP" password="#APPLICATION.mandrillPass#" port="587">
                        <cfoutput>
                            #local.serializedSendData#
                        </cfoutput>
                    </cfmail>
